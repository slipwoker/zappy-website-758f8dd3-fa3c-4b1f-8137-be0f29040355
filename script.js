    ...
    contactForm.addEventListener('submit', function(e) {
      ...
      for (let i = 0; i < formElements.length; i++) {
        ...
        if (field.tagName === 'INPUT' || field.tagName === 'TEXTAREA' || field.tagName === 'SELECT') {
          ...
          if (fieldValue && field.hasAttribute('minlength')) {
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "מור אופיס משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '758f8dd3-fa3c-4b1f-8137-be0f29040355',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '758f8dd3-fa3c-4b1f-8137-be0f29040355';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '758f8dd3-fa3c-4b1f-8137-be0f29040355';
